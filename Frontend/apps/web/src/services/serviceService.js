...
const serviceService = {
  ...
  updateService: async (id, serviceData) => {
    try {
      const response = await api.put(`/catalog/services/${id}`, serviceData);
      return response.data;
    } catch (error) {
  ...
  searchServices: async (query) => {
    try {
      const response = await api.get('/catalog/services/search', {
        params: { q: query }
      });
      return response.data;
    } catch (error) {
  ...
  getCategories: async () => {
    try {
      const response = await api.get('/catalog/services/categories');
      return response.data;
    } catch (error) {
